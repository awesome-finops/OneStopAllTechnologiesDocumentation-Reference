...
class KinesisStream:
    ...
    def __init__(self, kinesis_client):
        ...
        self.name = config["KinesisStream"]["Name"]
        self.details = None
    ...
    def create(self, wait_until_exists=True):
        """
        Creates a stream.
        ...
        try:
            ...
            print("Stream {} already exist".format(self.name))
    ...
    def fetch_records(self, max_records):
        """
